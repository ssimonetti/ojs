...
class SubmissionEditHandler extends SectionEditorHandler {
	...
	function submissionReview($args, &$request) {
		...
		// Pull draft configuration
		$draftingDisabled = Config::getVar('general', 'enable_drafting');
	...
	function draftDecision($args, &$request) {
		...
		// TODO: Use Request::isPost() and Request::getUserVar(...)
		if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_draft'])) {
			...
			// lets send an email to the editor
			// TODO: This English language text needs to be localized; URLs should not be assembled directly. Request::url should be used instead.
