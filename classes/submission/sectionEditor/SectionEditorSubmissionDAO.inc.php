...
class SectionEditorSubmissionDAO extends DAO {
	...
	// Get the draft decision by Section editor, to be approved by the main editor.
	...
	// TODO When possible, cast variables explicitly in DB calls. $articleId should be (int) $articleId
