	...
	<form method="POST">
		{if $view == 'view'}
			...
			{foreach from=$draft item=d}
				...
				{$d.note}<!-- TODO This needs to be escaped to prevent XSS problems. (Also elsewhere in this template) -->
				<h5>Subject:</h5><!-- TODO translate -->
				{$d.subject}
				<h5>Body:</h5><!-- TODO translate -->
				{$d.body|nl2br}
			{/foreach}
			<br /><br />
			{if $isEditor }	
			...
			{foreach from=$draft item=d}
				...
				<!-- TODO This needs to be escaped to prevent XSS problems. (Also elsewhere in this template) -->
